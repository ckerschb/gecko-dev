 ...
 *    - the server respsonds with a 302 redirect to a >> HTTP << script
...
function checkPopUpNotificationsForTest1() {
  ...
  var notification = PopupNotifications.getNotification("mixed-content-blocked", gTestBrowser.selectedBrowser);
