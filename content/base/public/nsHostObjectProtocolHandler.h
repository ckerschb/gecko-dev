...
public:
  ...
  NS_IMETHOD NewChannel2(nsIURI *aURI, nsIPrincipal *aPrincipal, uint32_t aSecurityFlags, nsContentPolicyType aContentPolicyType,
                         uint32_t aLoadFlags, nsIChannel * *_retval) MOZ_OVERRIDE;
